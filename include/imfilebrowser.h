...
namespace ImGui
{
    ...
    public:
        ...
        std::filesystem::path GetSelected(int* selected_id) const;
...
inline void ImGui::FileBrowser::Open(int id)
{
    UpdateFileRecords();
    ClearSelected();
